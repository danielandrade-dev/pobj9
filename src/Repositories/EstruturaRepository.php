...
use Pobj\Api\Entity\DEstrutura;
use Pobj\Api\Enums\Cargo;
...
class EstruturaRepository implements RepositoryInterface
{
    ...
    public function findAllSegmentos(): array
    {
        ...
        return $qb->select('DISTINCT e.idSegmento AS id, e.segmento AS nome')
    ...
    public function findAllDiretorias(): array
    {
        ...
        return $qb->select('DISTINCT e.idDiretoria AS id, e.diretoria AS nome')
            ->from(DEstrutura::class, 'e')
    ...
    public function findAllRegionais(): array
    {
        ...
        return $qb->select('DISTINCT e.idRegional AS id, e.regional AS nome')
            ->from(DEstrutura::class, 'e')
    ...
    public function findAllAgencias(): array
    {
        ...
        return $qb->select('DISTINCT e.idAgencia AS id, e.agencia AS nome, e.porte')
            ->from(DEstrutura::class, 'e')
    ...
    public function findAllGGestoes(): array
    {
        ...
        return $qb->select('DISTINCT e.funcional AS id, e.nome AS nome')
            ->from(DEstrutura::class, 'e')
            ...
            ->andWhere("e.nome != ''")
            ->setParameter('idCargo', Cargo::GERENTE_GESTAO->value)
            ->orderBy('e.nome', 'ASC')
            ->getQuery()
            ->getArrayResult();
    }
    ...
    public function findAllGerentes(): array
    {
        ...
        return $qb->select('DISTINCT e.funcional AS id, e.nome AS nome')
            ...
            ->andWhere("e.funcional != ''")
            ->andWhere("e.nome != ''")
            ->setParameter('idCargo', Cargo::GERENTE->value)
            ->orderBy('e.nome', 'ASC')
            ->getQuery()
            ->getArrayResult();
    }
    ...
    public function findGGestoesForFilter(): array
    {
        ...
        return $qb->select('DISTINCT e.funcional AS id, e.nome AS nome, e.cargo, id_cargo')
            ->from(DEstrutura::class, 'e')
            ->where('e.idCargo = :idCargo')
            ->andWhere('e.funcional IS NOT NULL')
            ->andWhere('e.nome IS NOT NULL')
    ...
    public function findGerentesForFilter(): array
    {
        ...
        return $qb->select('DISTINCT e.funcional AS id, e.nome AS nome, e.cargo, e.id_cargo')
            ->from(DEstrutura::class, 'e')
            ->where('e.idCargo = :idCargo')
            ->andWhere('e.funcional IS NOT NULL')
            ->andWhere('e.nome IS NOT NULL')
